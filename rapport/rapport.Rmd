...
# Méthode
## Choix de la zone d'étude (Kiks)
## Recherche et caractérisation de la desserte (Kiks et Louise)
## Création de buffer autour de la desserte (Louise)
## Calcul de la pente (Agnès)
...
## Carte de Kiks (parcellaire + desserte à 1km + type de routes + infrastructures)

## Cartes buffer desserte (Louise)

## Carte catégorie pentes (Elda)
