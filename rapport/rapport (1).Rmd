...
knitr::include_graphics("C:/Users/louis/OneDrive/Documents/AgroParistech/3AA/Cours R/Projet_exploit/Cartes_projet/agroparistech.png")
```
...
Ce projet à abouti à la création d'une carte d'exploitabilité couplant le relief et les distances de débardage par rapport aux pistes. Nous avons atteint les objectifs du projet en fournissant un outil permettant d'optimiser l'exploitation forestière et faciliter la prise de décision.
...
- converte par la technologie Lidar. Un axe d'étude étant la comparaison de différentes sources de MNT, il est judicieux de choisir une zone d'étude ayant déjà fait l'objet d'une campagne Lidar et dont les données retraitées sont disponibles.
- Supperficie raisonnable pour optimiser les temps de calcul 

La commune d'étude à été choisie suite à des validations des critères précédents est la commune de Saxel en Haute-Savoie. Saxel est une commune de 500 habitants recouverte à plus de 60 % par des zones forestières. lien wikipedia : https://fr.wikipedia.org/wiki/Saxel
...
![Carte de la desserte sur la commune de Saxel]("C:/Users/louis/OneDrive/Documents/AgroParistech/3AA/Cours R/Projet_exploit/Cartes_projet/Desserte sur la commune de Saxel.pdf")

## Cartes des buffers autours de la desserte

Ci-dessous la carte des buffers réalisée sur R :
![Carte des buffers sur la commune de Saxel (version R)]("C:/Users/louis/OneDrive/Documents/AgroParistech/3AA/Cours R/Projet_exploit/Cartes_projet/map_buffer.pdf")

Ci-dessous la carte des buffers réalisée sur QGis :
![Carte des buffers sur la commune de Saxel (version QGis)]("C:/Users/louis/OneDrive/Documents/AgroParistech/3AA/Cours R/Projet_exploit/Cartes_projet/Buffer Saxel.pdf")

## Carte catégories de pentes

Ci-dessous la carte des catégories de pentes réalisée sur QGis :
![Carte des distances de débardages sur la commune de Saxel]("C:/Users/louis/OneDrive/Documents/AgroParistech/3AA/Cours R/Projet_exploit/Cartes_projet/Pentes sur la commune de Saxel.pdf")

## Carte d'exploitabilité

Ci-dessous la carte d'exploitabilité réalisée sur QGis :
![Carte de l'exploitabilité sur la commune de Saxel]("C:/Users/louis/OneDrive/Documents/AgroParistech/3AA/Cours R/Projet_exploit/Cartes_projet/Exploitabilité Saxel.pdf")
